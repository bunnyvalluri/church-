...
export default function PastorDashboard() {
  ...
  const [usersCount, setUsersCount] = useState(1248);
  ...
  const loadDashboardResources = async () => {
    ...
    try {
      ...
      if (usersRes.ok && usersData.success) {
        setUsersCount(usersData.users?.length || 1248);
      }

      // 2. Fetch Sermons
      const srmRes = await fetch("/api/pastor/sermons");
      const srmData = await srmRes.json();
      let sermonList = srmData.sermons || [];
      if (sermonList.length === 0) {
        sermonList = [
          { id: "srm_1", title: "Walking in Faith", date: "2026-05-12T10:00:00Z", scripture: "Acts 3:1-10", duration: "32:45", status: "Published", thumbnail: "https://images.unsplash.com/photo-1438232992991-995b7058bbb3?w=300&q=80", category: "Worship" },
          { id: "srm_2", title: "God's Plan for Your Life", date: "2026-05-05T10:00:00Z", scripture: "Jeremiah 29:11", duration: "28:10", status: "Published", thumbnail: "https://images.unsplash.com/photo-1507692049790-de58290a4334?w=300&q=80", category: "Faith" },
          { id: "srm_3", title: "The Power of Prayer", date: "2026-04-28T10:00:00Z", scripture: "Philippians 4:6-7", duration: "41:22", status: "Published", thumbnail: "https://images.unsplash.com/photo-1504052434569-70ad5836ab65?w=300&q=80", category: "Prayer" },
          { id: "srm_4", title: "He is Risen!", date: "2026-04-21T10:00:00Z", scripture: "Luke 24:1-12", duration: "35:18", status: "Published", thumbnail: "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=300&q=80", category: "Special" }
        ];
      }
      ...
      if (prayerList.length === 0) {
        prayerList = [
          { id: "pry_1", userId: "usr_1", title: "Complete Healing of Joint Pains", description: "Please pray for my mother who is suffering from severe arthritis and joint pains.", category: "HEALTH", isAnonymous: false, status: "PENDING", createdAt: new Date(Date.now() - 60 * 60 * 1000).toISOString(), priority: "Urgent", user: { name: "John Smith", email: "john@smith.com" } },
          { id: "pry_2", userId: "usr_2", title: "Strength and Guidance", description: "Pray for strength and guidance as I navigate family struggles and challenges.", category: "FAMILY", isAnonymous: false, status: "PRAYING", createdAt: new Date(Date.now() - 3 * 3600 * 1000).toISOString(), priority: "Medium", user: { name: "Lisa Wilson", email: "lisa@wilson.com" } },
          { id: "pry_3", userId: "usr_3", title: "Missions Support", description: "Pray for the safety and success of our upcoming outreach teams traveling to remote fields.", category: "SPIRITUAL", isAnonymous: false, status: "PENDING", createdAt: new Date(Date.now() - 5 * 3600 * 1000).toISOString(), priority: "Low", user: { name: "Robert Taylor", email: "robert@taylor.com" } },
          { id: "pry_4", userId: "usr_4", title: "Job Opportunity", description: "Seeking a breakthrough in corporate recruitment. I need stability to support family expenses.", category: "FINANCIAL", isAnonymous: true, status: "PENDING", createdAt: new Date(Date.now() - 24 * 3600 * 1000).toISOString(), priority: "Medium", user: { name: "Amanda White", email: "amanda@white.com" } }
        ];
      } else {
      ...
      let eventList = evtData.events || [];
      if (eventList.length === 0) {
        eventList = [
          { id: "evt_1", title: "Sunday Worship Service", date: "2026-05-19", time: "10:00 AM", attending: 156, location: "Kingdom of Christ Sanctuary", category: "WORSHIP" },
          { id: "evt_2", title: "Midweek Bible Study", date: "2026-05-22", time: "07:00 PM", attending: 45, location: "Main Hall / Online Zoom", category: "PRAYER" },
          { id: "evt_3", title: "Youth Fellowship Night", date: "2026-05-25", time: "05:00 PM", attending: 32, location: "Activity Center", category: "YOUTH" },
          { id: "evt_4", title: "Community Outreach & Feeding", date: "2026-05-28", time: "09:00 AM", attending: 28, location: "Neighborhood Park", category: "SPECIAL" }
        ];
      }
      setEvents(eventList);
      ...
      setAnnouncements(ancData.announcements || [
        { id: "anc_1", title: "Vacation Bible School Registration Open", content: "Registration is now open for children ages 5-12. Volunteers are also needed for teachers and activities.", priority: "HIGH", createdAt: new Date(Date.now() - 2 * 24 * 3600 * 1000).toISOString() },
        { id: "anc_2", title: "Monsoon Relief Fund Collection", content: "We are organizing a relief collection of food grains, dry food, and blankets for flood-affected regions.", priority: "URGENT", createdAt: new Date(Date.now() - 5 * 24 * 3600 * 1000).toISOString() }
      ]);
