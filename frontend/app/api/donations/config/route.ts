  ...
  try {
    ...
    if (formFields.length === 0) {
      const defaultFields = [
        ...
        { fieldName: 'panNumber', label: 'PAN Number (for 80G Tax Receipt)', placeholder: 'ABCDE1234F', isRequired: false, isVisible: true, displayOrder: 4, fieldType: 'text' },
        { fieldName: 'address', label: 'Address', placeholder: 'Street address', isRequired: false, isVisible: true, displayOrder: 5, fieldType: 'text' },
        { fieldName: 'city', label: 'City', placeholder: 'Hyderabad', isRequired: false, isVisible: true, displayOrder: 6, fieldType: 'text' },
        { fieldName: 'state', label: 'State', placeholder: 'Telangana', isRequired: false, isVisible: true, displayOrder: 7, fieldType: 'text' },
        { fieldName: 'country', label: 'Country', placeholder: 'India', isRequired: false, isVisible: true, displayOrder: 8, fieldType: 'text' },
        { fieldName: 'prayerRequest', label: 'Prayer Request', placeholder: 'Optional prayer request...', isRequired: false, isVisible: true, displayOrder: 9, fieldType: 'textarea' },
        { fieldName: 'message', label: 'Personal Note', placeholder: 'Optional message...', isRequired: false, isVisible: true, displayOrder: 10, fieldType: 'textarea' },
