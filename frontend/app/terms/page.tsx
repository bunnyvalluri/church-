        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold font-heading text-white tracking-tight leading-tight mb-4">
              Terms of <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-indigo-300 to-purple-200">Service</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="pt-4 border-t border-white/10 mt-4 space-y-3">
                  <div className="p-3.5 rounded-xl bg-purple-950/40 border border-purple-800/40 text-xs text-purple-200">
                    <p className="font-semibold mb-1 flex items-center gap-1.5 text-purple-300">
                      <HelpCircle className="w-3.5 h-3.5" /> Need Legal Clarification?
                    </p>
            ...
            <div className="lg:col-span-8 xl:col-span-9 space-y-12">
              ...
              <section id="acceptance" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <Scale className="w-5 h-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">1. Acceptance of Terms</h2>
                </div>

                <p className="text-slate-300 leading-relaxed text-sm sm:text-base">
                  By accessing, browsing, or registering an account on the <strong>Kingdom of Christ Ministries (&quot;KCM&quot;)</strong> platform (including <code>kcm-portal.vercel.app</code> and associated subdomains), you confirm that you have read, understood, and agree to be bound by these Terms of Service, along with our <Link href="/privacy" className="text-purple-400 underline font-medium">Privacy Policy</Link>.
                </p>
              ...
              {/* Section 2: Services */}
              <section id="services" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <ScrollText className="w-5 h-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">2. Ministry Portal Scope & Services</h2>
                </div>
              ...
              <section id="accounts" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <UserCheck className="w-5 h-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">3. User Registration & Security Responsibilities</h2>
                </div>
              ...
              <section id="conduct" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <Heart className="w-5 h-5 text-rose-400" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">4. Community Guidelines & Conduct</h2>
                </div>
                ...
                <div className="p-4 rounded-xl bg-rose-950/30 border border-rose-800/40 text-rose-200 text-xs sm:text-sm space-y-2">
                  <strong className="text-white block font-semibold flex items-center gap-2">
                    <ShieldAlert className="w-4 h-4 text-rose-400" /> Prohibited Portal Conduct:
                  </strong>
              ...
              <section id="ip" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <Sparkles className="w-5 h-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">5. Intellectual Property & Sermon Media</h2>
                </div>
              ...
              <section id="giving" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <DollarSign className="w-5 h-5 text-emerald-400" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">6. Online Giving, Tithes & Donation Policy</h2>
                </div>
                ...
                <div className="space-y-3 text-xs sm:text-sm text-slate-300">
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    <strong className="text-white">Voluntary Contributions:</strong> All donations are voluntary acts of worship and charitable support.
                  </div>
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    <strong className="text-white">Tax Receipts & 80G:</strong> Official receipts for tax deductions are issued electronically following successful payment confirmation.
                  </div>
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    <strong className="text-white">Refund Policy:</strong> Tithes and offerings are generally non-refundable once processed. In the event of a technical duplicate charge, please contact <a href="mailto:finance@kcmministries.org" className="text-purple-300 underline">finance@kcmministries.org</a> within 7 days.
                  </div>
                </div>
              </section>

              {/* Section 7: Events */}
              <section id="events" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <Calendar className="w-5 h-5 text-indigo-400" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">7. Church Events & Registrations</h2>
                </div>
              ...
              <section id="liability" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <AlertTriangle className="w-5 h-5 text-amber-400" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">8. Disclaimers & Limitation of Liability</h2>
                </div>
              ...
              <section id="governing" className="p-8 rounded-2xl bg-slate-900/60 border border-white/10 space-y-4 shadow-lg">
                <div className="flex items-center gap-3 text-purple-400">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                    <Gavel className="w-5 h-5" />
                  </div>
                  <h2 className="text-2xl font-bold text-white font-heading">9. Governing Law & Jurisdiction</h2>
                </div>
              ...
              <section id="changes" className="p-8 rounded-2xl bg-gradient-to-br from-purple-900/40 via-slate-900 to-indigo-950/40 border border-purple-500/30 space-y-6 shadow-xl">
                <div className="flex items-center gap-3 text-purple-300">
                  <div className="w-10 h-10 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center">
                    <Mail className="w-5 h-5 text-purple-200" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold text-white font-heading">10. Modifications & Contact Details</h2>
                    <p className="text-xs text-purple-200/80">Kingdom of Christ Ministries — Legal & Pastoral Administration</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                  ...
                  <div className="p-4 rounded-xl bg-slate-950/60 border border-white/10 space-y-1">
                    ...
                    <strong className="text-white block">Legal Enquiries</strong>
                    <a href="mailto:legal@kcmministries.org" className="text-purple-300 hover:underline">legal@kcmministries.org</a>
                  </div>

                  <div className="p-4 rounded-xl bg-slate-950/60 border border-white/10 space-y-1">
                    <Phone className="w-4 h-4 text-purple-400 mb-1" />
                    <strong className="text-white block">Administration Office</strong>
