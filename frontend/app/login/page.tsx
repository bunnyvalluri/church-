  ...
  return (
    <div className="min-h-[100dvh] flex flex-col lg:grid lg:grid-cols-2 bg-slate-50 dark:bg-slate-950 font-sans antialiased text-slate-900 dark:text-gray-100 selection:bg-purple-500 selection:text-white relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col justify-start lg:justify-center items-center px-3 py-4 sm:px-8 sm:py-10 lg:p-12 w-full min-w-0 bg-slate-100/90 dark:bg-slate-950 relative overflow-y-auto min-h-[100dvh] lg:min-h-0 transition-colors duration-300">
        ...
        {/* Mobile Header Bar */}
        <div className="w-full max-w-md flex items-center justify-between pt-1 px-1 mb-3 lg:hidden z-20 shrink-0">
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, ease: "easeOut" }}
          className="w-full max-w-md mx-auto bg-white/95 dark:bg-slate-900/80 p-4 sm:p-8 rounded-3xl shadow-2xl border border-slate-200/90 dark:border-white/10 backdrop-blur-2xl z-10 min-w-0 box-border relative overflow-hidden transition-colors duration-300 my-auto"
        >
