...
export default function LanguageToggle() {
  ...
  return (
    <div className="flex items-center gap-0.5 p-0.5 sm:p-1 bg-slate-200/80 dark:bg-white/10 rounded-xl border border-slate-300/80 dark:border-white/15 shadow-inner shrink-0">
      {languages.map((lang) => {
        ...
        return (
          <button
            ...
            className={`px-1.5 sm:px-3 py-1 sm:py-1.5 text-[9px] sm:text-[10px] font-extrabold uppercase rounded-lg transition-all duration-200 active:scale-95 ${
              isActive
