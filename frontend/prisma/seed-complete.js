...
async function main() {
  ...
  for (const user of users) {
    await prisma.user.upsert({
      ...
      update: { name: user.name, role: user.role, phone: user.phone, password: user.password },
      create: user,
    });
  }
  ...
  const pastors = [
    ...
    },
    {
      ...
      bio: 'Pastor Kristhuraju leads the youth ministry and community outreach programs. A graduate of Osmania University and trained at Chennai Bible Seminary, he brings energy and vision to reach the next generation for Christ. He oversees Sunday school, VBS, and the annual youth camp.',
      email: 'pastor.kristhuraju@kcm-church.com',
      phone: '+91 87654 32109',
      image: '/pastor.png',
    },
